...
Le progressive enhancement est à l'honneur aussi bien coté Remix que Next.js!
...
https://twitter.com/TkDodo/status/1708134790065434770
...
- 📜 [Custom Apple Settings UI with Expo](https://evanbacon.dev/blog/apple-settings): Evan rappelle les quelques avantages d'utiliser l'écran natif de settings iOS. C'est difficile à implémenter nativement, et le ROI est faible, mais son Expo Config Plugin simplifie la tâche. Il explique comment toggle le son d'une app ou encore automatiser l'affichage des licenses logicielles.
