...
La semaine je me suis trompé, j'ai envoyé l'édition 220 au lieu de 120 😅 Personne n'a remarqué, ça doit pas être très grave.
...
La conférence Next.js démarre dans quelques heures. On va surement avoir une annonce de Next.js 13, avec les nested layouts, et d'autres trucs cools qui commencent par Turbo 🤭.
...
Ne manquez pas non plus [la saison 5 des vidéos React-Native de William Candillon](https://twitter.com/wcandillon/status/1579534710140964864) qui démarre aujourd'hui! [Première vidéo](https://www.youtube.com/watch?v=pErnuAx5GjE) déjà dispo.
...
- 📜 [Currying Layout Component Patterns in Next.js](https://creativedesignsguru.com/currying-nextjs-layout/): suggère de paramétriser la fonction `getLayout` de Next.js pour créer de légères variations de layout sans pour autant unmount/remount.
