...
- `defer` + `<Await>` pour initier une réponse streamée dans laquelle certaines réponses du loader peuvent être affichées plus tard.
...
- 📜 [The building blocks of great docs](https://www.mux.com/blog/the-building-blocks-of-great-docs): migration en cours d'une documentation technique vers Next.13. L'usage de Server Components apporte beaucoup de bénéfices sur un site de contenu assez statique.
