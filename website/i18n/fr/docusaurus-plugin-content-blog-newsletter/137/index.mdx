...
Melvyn a lancé sa formation [NextReact](https://codelynx.dev/nextreact) en français, basée sur les dernières nouveautés React, y compris les Server Components.
