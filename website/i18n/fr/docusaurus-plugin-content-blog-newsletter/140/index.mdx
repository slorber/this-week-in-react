...
- React Server Components. Une belle implémentation est déjà dispo dans Next.js via App Router. Les RSCs avec async/await devraient aussi pouvoir tourner dans une app client. J'ai l'impression qu'ils veulent unifier les abstractions coté client/server (et je pense que [Async Context](https://twitter.com/sebastienlorber/status/1639183216799100928) va être super pour ça!). Je trouve que pas mal d'innovations liées RSCs qui ne sont pas encore trop mises en avant.
...
- React Optimizing Compiler: le compiler React Forget n'est plus présenté comme un "auto-memoizing compiler", mais plutôt comme un "reactivity compiler". D'ailleurs [Joe Savona vient d'annoncer que React Forget a atteint un milestone](https://twitter.com/en_JS/status/1641494974893281282) et qu'ils se concentrent maintenant sur l'intégration.
- Offscreen Rendering: c'est vraiment une innovation qui différencie React des autres frameworks, et que j'attends avec impatience. Meta est déjà en train de tester le prerendering sur des apps React-Native avec des gains de performance.
