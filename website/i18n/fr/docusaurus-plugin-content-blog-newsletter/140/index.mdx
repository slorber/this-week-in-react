...
- 📜 [Streaming for Serverless Node.js and Edge Runtimes with Vercel Functions](https://vercel.com/blog/streaming-for-serverless-node-js-and-edge-runtimes-with-vercel-functions)
...
- 📜 [How Migrating from Vanilla Redux to Redux Toolkit Improved State Management in Shopify POS](https://shopify.engineering/react-redux-toolkit-migration): retour d'expérience de Shopify sur une migration incrémentale vers RTK qui a permis de supprimer 3500 lignes de boilerplate.
