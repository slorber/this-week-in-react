...
- 📖 [New Next.js documentation](https://twitter.com/leeerob/status/1654181055740497939): la nouvelle doc beta est déployée avec de nombreuses améliorations, mais surtout le contenu qui touche aux dernières innovations comme App Router et Server Components.
...
- 📦 [Ink UI - Themable UI components for your next CLI](https://twitter.com/vadimdemedes/status/1655567427885846534): belle démonstration des capacités cross-platform de React.
