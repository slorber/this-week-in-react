...
Je compte sauter l'édition de la prochaine semaine, on se retrouve donc le 24 Mai 👋
...
- 📦 [server-only](https://www.npmjs.com/package/server-only): un package qui permet d'empêcher l'import de code serveur dans les Client Components ([doc Next.js](https://nextjs.org/docs/getting-started/react-essentials#keeping-server-only-code-out-of-client-components-poisoning)).
