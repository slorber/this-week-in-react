...
Rejoignez notre communauté florissante ainsi que le serveur [Discord](https://discord.gg/wt3HC9eN), afin de rester au courant des dernières mises à jour de React-admin et d'obtenir l’aide d'un réseau de développeurs expérimentés.
