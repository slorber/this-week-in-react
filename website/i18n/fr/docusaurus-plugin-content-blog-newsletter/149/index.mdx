...
[Isograph - The best client for building React apps powered by GraphQL data.](https://isograph.substack.com/p/introducing-isograph)
...
- 📜 [Environment Variables in React Native: The Right Way](https://elazizi.com/posts/environment-variables-in-react-native-the-right-way/): une méthode typesafe pour charger et accéder aux variables d'environnement dans un contexte Expo.
