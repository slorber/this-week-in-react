...
Server components ts`async/await`

use for React client comnents, React version of await, can be used in conditions

Other usable types: promise, context, store?, observable: https://github.com/acdlite/rfcs/blob/first-class-promises/text/0000-first-class-support-for-promises.md#other-usable-types

Consistent abstraction => change mind => use different apis for client/server. underestimated how frequently Server Components might need to perform ad hoc asynchronous operations

Help distinguish client/server components => pit of success for designing components

compilation => Crankjs?

=> plus possible de throw une promise
