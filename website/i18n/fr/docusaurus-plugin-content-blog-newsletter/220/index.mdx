...
Ils ont aussi lancé [Web Publisher](https://twitter.com/sebastienlorber/status/1580206198803922945), une vue d'édition simplifiée dédiée à l'édition de doc Markdown. Cela sera très pratique pour les utilisateurs moins techniques qui veulent éditer des fichiers Markdown sur Git et avoir une véritable preview (et non pas l'expérience dégradée de la preview GitHub). C'est un [besoin important pour les utilisateurs Docusaurus](https://twitter.com/ericsimons40/status/1580371754974781440).

**[Fontaine - Automatic font fallback based on font metrics](https://github.com/unjs/fontaine)**

Propose d'éviter les layout shifts liés au chargement de font. Fait en sorte que les lettres de la font de fallback aient la même dimension que la font finale, pour que le switch de font n'impacte pas la taille des conteneurs texte. Super idée! 👌
