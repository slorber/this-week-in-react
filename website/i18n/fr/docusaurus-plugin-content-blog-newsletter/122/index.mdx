...
- [Sebastian McKenzie](https://twitter.com/sebmck/status/1584971938786861056) pointe le gain relativement faible de performance sur un cold start (x4).
...
Three.js Journey est le cours de référence pour apprendre à créer des scenes 3D sur le web avec Three.js. Bruno Simon vient tout juste de sortir 24h de vidéos supplémentaires basées sur [React-Three-Fiber](https://github.com/pmndrs/react-three-fiber) qui apporte un modèle déclaratif à Three.js. La 3D est en train de prendre de l'ampleur dans nos applications: c'est le bon moment pour s'y mettre si vous voulez savoir faire autre chose que des formulaires et des applications de gestion. J'ai moi même commencé à apprendre avec ce cours en début d'année (cf mon repo [react-three-fiber-journey](https://github.com/slorber/react-three-fiber-journey)) et je ne regrette pas du tout!

Bruno m'a offert un code promo [TWIR](https://threejs-journey.com/join/TWIR) de -30% pour vous le proposer au tarif attractif de 66$ pendant les 10 prochains jours. Je précise que ce n'est pas du contenu sponsorisé, et je ne gagne rien sur les ventes: je trouve ce cours super cool, et cette mise à jour le rend encore plus pertinent pour un dev React.

Pour info, je compte créer une page "deals" pour les lecteurs de ma newsletter avec d'autres cours de ce genre et des promos intéressantes (sur lesquelles je ne gagne rien du tout).

---

- 🤔 [React core - Add fetch Instrumentation to Dedupe Fetches](https://github.com/facebook/react/pull/25516): React monkey-patch `fetch`. Fait [polémique](https://github.com/facebook/react/issues/25573).
...
https://twitter.com/zachleat/status/1587428512058728448
