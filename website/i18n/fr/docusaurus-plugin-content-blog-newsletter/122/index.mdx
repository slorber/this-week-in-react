...
Ne manquez pas non plus la grosse mise à jour du cours Three.js Journey avec les modules React-Three-Fiber, pour lequel Bruno m'a partagé un code promo ["TWIR"](https://threejs-journey.com/join/TWIR). Cela sera le 1er cours qui figurera sur une prochaine page "deals" pour les lecteurs de la newsletter.
