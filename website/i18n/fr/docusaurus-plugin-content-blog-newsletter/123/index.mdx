...
- 📜 [React Router 6 Deferred Fetch](https://dev.to/infoxicator/react-router-6-deferred-fetch-4k68): article assez cool qui montre comment utiliser l'API `defer` de React-Router/Remix, et met en avant quelques subtilités à comprendre pour la gestion des erreurs et éviter les waterfalls.
