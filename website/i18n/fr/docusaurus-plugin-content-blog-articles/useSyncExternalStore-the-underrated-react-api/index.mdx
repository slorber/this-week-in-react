...
Dans cet article interactif, je souhaite te présenter un problème : **les hooks React retournent qui trop et déclenchant des re-renders inutiles**. On va aussi voir comment `useSyncExternalStore()` peut être une bonne solution.
