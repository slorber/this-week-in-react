...
Dans cet article interactif, je veux te présenter un problème : **les hooks React retournent qui trop et déclenchant des re-renders inutiles**. Nous allons voir comment `useSyncExternalStore()` peut être une bonne solution.
...
Ce site web utilise React-Router v5 : la solution sera différente pour React-Router v6.
