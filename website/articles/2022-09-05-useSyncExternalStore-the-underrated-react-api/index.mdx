...
In this interactive article, I want to present you a problem: **over-returning React hooks triggering useless React re-renders**. We will see how `useSyncExternalStore()` can be a good fix.
