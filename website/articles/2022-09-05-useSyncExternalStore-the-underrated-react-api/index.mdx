...
Whenever a hook returns data that you don't even display, think about React re-renders. If you don't pay attention, a tiny `useLocation()` call added at the top of a React tree could ruin your whole app's performance.
