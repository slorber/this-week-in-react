...
- ⚛️ React section:
  - 👀 Headlines
  - [**⚡️Quick Link sponsor**](#sponsor-quick-link)
  - 🔗 Links
...
This placement offers a generous ad copy length, in the first half of the newsletter.
...
### ⚡️ Quick Link {#sponsor-quick-link}

Quick Links are sponsored links inserted in the React or React-Native newsletter sections, alongside the regular content. **Subscribers can't miss them**, right between the section headlines and the list of links.
...
<details>
    ...
    **Placement constraints:**
    ...
    - **Title**: respects pattern `<ProductName> - <Description>` whenever possible
...
Quick Links are ideal to:

- promote a React or React-Native product
- promote a or a **piece of content** such as a product tutorial blog post
...
Reach out to [sponsor@thisweekinreact.com](mailto:sponsor@thisweekinreact.com?subject=Custom%20sponsorship%20offering) to discuss in details your sponsorship needs. We can create a custom offer to help you achieve your marketing goals, including:

- custom offer packages
- sponsored placement on our occasional [React articles](/articles)
- sponsored honest review of your product
- sponsored issue dedicated to your product
...
Alternatively, you can also provide us with all the information we need straight away.

To order a sponsorship slot, we need you to:
...
- acknowledge receipt of the invoice we sent you
