...
// TODO automate this!
export const lastIssueLink = "/newsletter/145";
...
const all: NewsletterSegment & NewsletterFuture = {
  ...
  nextMainSlot: {
    date: "December 2023",
    projectedAudienceSize: subscribersCount + 7 * growthPerMonth,
  },
  nextSecondSlot: {
    date: "May 2023",
    projectedAudienceSize: subscribersCount + 1 * growthPerMonth,
  },
};
