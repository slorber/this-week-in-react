---
slug: /197
title: "This Week In React #197: Waku, Effect, TanStack, Framer Motion, use(), Preact, Valtio, Astro, Three.js, Nitrogen, react-native-web, expo-dom, Tophat, Skip, TypeScript, Rspack..."
authors: [slorber]
date: 08-21-2024
unlisted: true
---
...
[![Waku v0.21 adds full support for React Server Actions](/emails/issues/197/waku.jpg)](https://waku.gg/blog/server-actions-are-here)

**[Waku v0.21 adds full support for React Server Actions](https://waku.gg/blog/server-actions-are-here)**
...
**[React Native 0.75 released](https://reactnative.dev/blog/2024/08/12/release-0.75)**
