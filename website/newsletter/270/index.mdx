...
- 👀 [React Native PR \- CSS Grid is coming to React Native](https://github.com/facebook/react-native/pull/55665%20)
...
- 🐦 [React Navigation 8 is experimenting with `<Activity>` for freezing and unmounting inactive screens](https://x.com/reactnavigation/status/2025525954618052746%20)
