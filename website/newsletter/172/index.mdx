...
https://twitter.com/ThisWeekInReact
...
Second: this incredibly well-produced video has been created with [Remotion](https://www.remotion.dev/), using React web code 🙉. Good job Delba, you nailed it! We can’t wait to see more videos like this and to know more about your Remotion creative process. On a related note, Remotion just shared a [behind the scene of GitHub Unwrapped 2023](https://www.youtube.com/watch?v=WW8vIZ1kwR0).
...
This section is co-authored with [Benedikt](https://twitter.com/bndkt). Feel free to send us your comments by email or on Twitter!

[State of React Native 2023 Results are out!](https://results.stateofreactnative.com/)
...
- 🎥 [Expo SDK 50 - Launch Livestream](https://www.youtube.com/watch?v=cKFSVUo3AnI): Happening today!
