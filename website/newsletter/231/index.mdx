---
slug: /231
title: "This Week In React #231: React Compiler, React Router, Next.js, Tanstack Query, Tailwind, c15t, Redux Toolkit, Headless Tree, Module Federation, Base UI | LegendList, FlashList, Metro, ExecuTorch, React Native Brownfield, Expo Router | TC39, State of AI, Node.js, GitHub Actions, Rspack, tsdown"
...
[![LegendList 1.0](/emails/issues/231/legend-list.png)](https://bsky.app/profile/jayz.us/post/3lni5ofbuvs2s)

**[LegendList 1.0](https://bsky.app/profile/jayz.us/post/3lni5ofbuvs2s)**
...
LegendList is now in version 1.0, and promises to be even faster than `FlashList`, all the while handling the "hard cases": bidirectional infinite lists, varying item sizes… And it's compatible with the old arch (though less performant and with possible glitches).
