...
This week, the React Compiler is in RC (have you enabled it yet?) and the React team has a special announcement for you.

We've also been reading a quite a few interesting blog posts from the "official" blogs and from the community.
