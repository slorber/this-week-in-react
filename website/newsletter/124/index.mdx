...
An interactive diagram that demonstrates the life cycle of a React component, including hooks, refs, and DOM updates/paint (not available on mobile). Also includes a quiz to test your knowledge, and many quotes/references.
...
- 📜 [Fetching data in React: the case of lost Promises](https://www.developerway.com/posts/fetching-in-react-lost-promises): well-illustrated article on the races conditions that can occur when making requests. Gives several techniques to avoid them. I also wrote an [article](https://sebastienlorber.com/handling-api-request-race-conditions-in-react) on the subject 😜 (both are worth reading, quite complementary)
...
- [TypeScript satisfies operator](https://tomdohnal.com/posts/typescript-satisfies-keyword): exemple of satisfies coming witn TS 4.9
