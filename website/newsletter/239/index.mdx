...
- 📦 [React Native Gesture Handler 2.26](https://github.com/software-mansion/react-native-gesture-handler/releases/tag/2.26.0) – RN 0.80 support, relation props in Pressable.
- 📦 [create-react-native-library 0.51](https://github.com/callstack/react-native-builder-bob/releases/tag/create-react-native-library%400.51.0) – 16 KB page size on Android.
...
- 🎙️ [Rocket Ship \#072 – The Frozen Arch, Killing my App & React Native World Domination](https://share.transistor.fm/s/43ce5c20)
