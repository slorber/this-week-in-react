---
slug: /189
title: "This Week In React #189: React State, Typesafe Routes in Remix, Starlight, Next.js Security, Hydrogen, Memoization, useFormStatus, Lingui, Skia Video, Starlink, App Clips"
authors: [bndkt]
date: 06-12-2024
unlisted: true
---
...
- 🐦 [Typesafe route modules coming to Remix/React Router 7](https://x.com/pcattori/status/1799194706850504818)
...
- 📜 [Starlight (the Astro-based documentation builder) turns one year old](https://astro.build/blog/starlight-turns-one/): Pretty impressive stats: 24 minor releases, 181 contributors, 2,000 commits, 4,000 GitHub stars, and 2,700 open-source Starlight sites.
...
- 🎙️ [PodRocket: Mid-year recap, Vercel Ship, and remixing React Router](https://podrocket.logrocket.com/mid-year-recap-vercel-ship-remixing-react-router) ???
- 🎥 [React Compiler: It's Stranger Than You Think](https://www.youtube.com/watch?v=wnXGSwrOw80)
...
- 🎥 [Expo SDK 51: New Architecture, Router 3.5, Faster 'getting started' flow and more](https://www.youtube.com/watch?v=k1ISWPgP4S4)
- 🎥 [Building a Local-First React Native App with PowerSync and Supabase](https://www.youtube.com/watch?v=xvvVGOyRgZg)
...
- [Announcing TypeScript 5.5 RC](https://devblogs.microsoft.com/typescript/announcing-typescript-5-5-rc/?t)
...
[![Dirty code](/emails/issues/189/meme.jpg)](https://x.com/potetotes/status/1799527713952166383)
