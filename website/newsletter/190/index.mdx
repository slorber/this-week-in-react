...
This week I (Seb) am back from my break, and happy to share that the newsletter crossed 40 000 subscribers! 🎉 \
Thank you all for your support and for sharing the newsletter with your friends and colleagues. If you have any idea to make it even better, just hit reply to this email.

The React 19 stable released that we expected very soon is delayed a bit by a controversial Suspense behavior change.

On the React Native side, the first RC of 0.75 is expected very soon and should use React 19.
