...
- 👀 [First React Native 0.75 PRs start showing up (e.g. bump dependency to React 19](https://github.com/facebook/react-native/pull/44990) + [#44991](https://github.com/facebook/react-native/pull/44991) + [#44989](https://github.com/facebook/react-native/pull/44989)
- 👀 [PR: requestIdleCallback in React Native](https://github.com/facebook/react-native/pull/44759): Schedule background and low-priority work on the main event loop.
- 📖 [Expo Docs: React Compiler - Available from Expo SDK 51 and still experimental, of course](https://docs.expo.dev/guides/react-compiler/)
...
- 📜 [The Inner Workings of GPU Rendering for 2D and 3D Graphics](https://www.callstack.com/blog/the-inner-workings-of-gpu-rendering-for-2d-and-3d-graphics)
...
- 📦 [react-native-screens 3.32.0 - Back button display mode on iOS, 𝚗𝚊𝚟𝚒𝚐𝚊𝚝𝚒𝚘𝚗𝙱𝚊𝚛𝚃𝚛𝚊𝚗𝚜𝚕𝚞𝚌𝚎𝚗𝚝 prop on Android](https://github.com/software-mansion/react-native-screens/releases/tag/3.32.0)
