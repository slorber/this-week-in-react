...
Looking for a great React summer conf? [React Rally](https://reactrally.com/?utm_source=thisweekinreact) (August 12-13, 🇺🇸 Utah) tickets are on sale. They offer us a [10% discount](https://ti.to/react-rally/react-rally-2024/discount/TWIR) with code "TWIR".

Speaking of discounts, Josh Comeau is also offering one for his flagship course [The Joy of React](https://www.joyofreact.com/). Our readers get an [extra 10% off](https://courses.joshwcomeau.com/checkout/joy-of-react/ultimate?couponCode=TWIR) with code "TWIR".
