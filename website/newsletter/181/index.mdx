...
[React Core - Add onCaughtError / onUncaughtError, improve onRecoverableError](https://github.com/reactjs/react.dev/pull/6742)
...
- 👀 [React Core - Add onCaughtError/onUncaughtError, improve onRecoverableError](https://github.com/reactjs/react.dev/pull/6742) + [https://twitter.com/sebastienlorber/status/1778033530632544335](https://twitter.com/sebastienlorber/status/1778033530632544335)
...
- 📜 [Snapshot testing with Rea](https://wanago.io/2024/04/08/javascript-testing-snapshots-react-jest-vitest/)[Techniques for Fetching Data: Comparing Next.js (app and pages API), Remix, and RedwoodJS](https://redwoodjs.com/blog/techniques-for-fetching-data)[ct, Jest, and Vitest](https://wanago.io/2024/04/08/javascript-testing-snapshots-react-jest-vitest/)
...
- 🎥 [James Quick - Don’t Make This Mistake with Next.js Server Components (Bad performance!)](https://www.youtube.com/watch?v=F_AplRX3dJU)
...
🐦 [**New 3D library for React Native in the works**](https://x.com/mrousavy/status/1775840325161853389)

One of the most inspiring things in the RN community is observing folks like Marc Rousavy and William Candillon pushing the boundaries of what’s possible with this technology and going far beyond rendering text and buttons on a screen. With the recent Skia announcements, we saw the state of the art regarding 2D rendering in RN. Now, Marc provided a sneak peek of some exciting advancements in 3D rendering with RN. Apparently, Margelo is working on a new library to enable access to the native Graphics APIs (Metal/Vulkan) from RN. Apart from the short [demo video](https://x.com/JPoliachik/status/1775866218743787934), I also found this [thread](https://x.com/mrousavy/status/1775870100945461277) very interesting, where Marc explains their approach using a C++ library and why they didn’t go with Three.js, which is amazing on web.
...
- 🐦 [VisionCamera rendering straight to Skia](https://x.com/mrousavy/status/1776326923674661065): This will come with Vision Camera 4, which seems to be nearing its release.
