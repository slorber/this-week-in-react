...
Many great research projects are being dogfooded at Meta on real production projects improving the framework and ecosystem for all of us along the way. We were perhaps a little disappointed that Threads didn't use React Native, but with all this, we can say with certainty that Meta will continue to bet on React as an excellent cross-platform solution.

See also this [commented video from Theo](https://www.youtube.com/watch?v=GjBfD9PHff4).
...
- 📦 [JSX Email 2.0 - config file, plugins, email compat, CSS inlining, new components](https://jsx.email/docs/v2/migration) [https://x.com/shellscape/status/1842292143152574765](https://x.com/shellscape/status/1842292143152574765)
...
- 📜 [Payhip boosts seller experience with Expo-powered mobile app](https://expo.dev/blog/payhip-boosts-seller-experience-with-expo-powered-mobile-app)
