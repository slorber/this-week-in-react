...
- 👀 [React IDE](https://youtu.be/C8Mg-NSyqWg?t=14452): Mofei from the React Compiler team unveils at React Summit the plan to work on a VSCode extension powered by the compiler. We don't know much more about it yet, so don't get too excited.
