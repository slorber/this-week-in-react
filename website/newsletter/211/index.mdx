---
slug: /211
title: "This Week In React #211: React Router, TanStack, Next.js, Vite, RSCs, Aria, Rslib, React-Scan, Screens, Edge-to-Edge, RN 0.77 RC, Legend List, Rapier, Testing Library, Cali, Nitro, Solito"
authors: [slorber]
date: 11-27-2024
unlisted: true
---
...
- Screen pre-loading for native stack to improve perceived performance
...
- 📦 [React Native 0.77.0-rc.0](https://github.com/facebook/react-native/releases/tag/v0.77.0-rc.0): The init template uses Swift instead of Objective-C. Improved CSS support (display contents, mixBlendMode). There’s ongoing work to clarify the native public API surface.
