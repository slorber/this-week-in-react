...
Je vous propose aussi de découvrir la nouvelle [newsletter Web Game Dev](https://www.webgamedev.com/newsletter). Elle fera sans doute un meilleur travail que moi pour vous tenir informer sur le dev web créatif, y compris tout ce qui touche à React-Three-Fiber.
