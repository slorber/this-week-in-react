...
title: "This Week In React: React Summit 2024 Recap"
authors:
...
Addy Osmani delivered an exciting review of the latest Chrome DevTools features and highlighted the INP metric. Here’s a summary of the main points covered:
...
## Kent C. Dodds’ talk, "Abracadabra: The Vanishing Network," traces web app evolution from multi-page apps (MPAs) to React Server Components (RSC).

Web app development has evolved to meet the growing demands of users and developers. Let’s look at the key stages of this evolution highlighted in the talk:
...
Shruti Kapoor (Frontend engineer at Slack) provides an overview of the forthcoming stable update to the React library, which promises a lot of new and exciting things. Here are the key features of the new version of React as told by Shruti Kapoor:
