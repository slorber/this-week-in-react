...
This week it looks like we finally entered the summer/holiday season and the pace of major React announcements is slowing down. We will also be taking a short summer break, skip 2 issues, and be back on July 17.
...
- 📜 [Client guide to React Native modules](https://ospfranco.com/client-guide-to-react-native-modules/): Oscar explains the differences, pros, and cons of the different ways to expose native modules to React Native, and helps us choose the best solution depending on context.
