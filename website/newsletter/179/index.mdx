...
The party is not over, because next month we also have [React Connection](https://reactconnection.io/) and [React Native Connection](https://reactnativeconnection.io/) the 22-23 April in Paris! By the way the newsletter is once again a conf media partner. You can get a [-20% discount](https://www.billetweb.fr/react-connection-2024?discount=TWIR) with the code "TWIR", and we'll run a ticket giveaway on Twitter this Friday.
...
- 👀 [React Core PR - useActionState](https://github.com/facebook/react/pull/28491): The PR is now merged and in the process of being added to the Canary changelog.
