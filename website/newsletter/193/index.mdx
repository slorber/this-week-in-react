...
- 👀 [Next.js PR - next/form](https://github.com/vercel/next.js/pull/68102): A new `<Form>` component for Next.js is being worked on. I don’t know yet what it will do.
- 📜 [Data Fetching with Server Actions in Next.js](https://www.robinwieruch.de/next-server-actions-fetch-data/): You can use Server Actions to fetch client data using React-Query. There are limitations to consider though: they use POST requests and run sequentially.
...
- 📦 [Simple Stack - A simple library to query the DOM from your Astro components](https://simple-stack.dev/query)
...
- 📦 [Experimental expo-doctor feature that validates project dependencies against reactnative.directory metadata](https://x.com/notbrent/status/1814016564452315374): Lets you know when you’re using libraries that are not maintained any longer or don’t support the New Arch.
