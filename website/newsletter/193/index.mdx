...
I found some great articles on abstractions in React, as well as feedback and case studies from various companies.

Astro has released Server Islands, and it looks like a pretty simple but compelling solution to rival with Next.js Partial Prerendering. There's also the Renaissance of Meteor to look forward to, React Aria releases, the new Gluestack-UI v2 for Universal React Native.
