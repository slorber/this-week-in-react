---
slug: /285
title: "This Week In React #285: React.foundation, React Compiler, Sätteri, Motion, TanStack Table, React Router, Flow, NavLink | Runtimes, JSI, Standard Navigation, Testing Library, Static Hermes, BottomTabs, AGP, AI, Windows | VoidZero, npm, Rolldown, Angular"
authors: [slorber]
date: 06-10-2026
---
...
On the mobile side, v0.86 is around the corner. Apparently, they always release on Wednesday evenings just to annoy us 😅, so we’ll cover it next week. Never mind, let’s focus on React Native Runtimes instead, a quite interesting innovation.
...
[![The React.Foundation website](/emails/issues/285/foundation.jpg)](https://react.foundation/)
...
[![alt](/emails/issues/285/meme.jpg)](https://x.com/sebastienlorber/status/2064657668044640285)
