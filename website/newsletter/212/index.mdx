...
This week React developers have either been super grateful, or have been busy spending money on useless things. Luckily, Astro is here to make the headline. We also have 2 great React perf articles.

The React Native ecosystem has been more active, with the official launch of Radon IDE, and many interesting releases.

Node 22.12 is here, with require(esm) the default. There's also a TC39 meeting in progress with ES proposals progressing, but that's for next week!
