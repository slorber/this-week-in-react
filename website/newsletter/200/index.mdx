...
This week is all about server components, with new features related to them in Vite and Next.Js. We also have a few articles on the topic that you might want to read.  
...
- 📦 [Remix 2.12 - Single Fetch improvements \+ `future.unstable\_optimizeDeps`](https://remix.run/docs/en/main/start/changelog#v2120)  
- 📦 [React Router 6.26.2 - Update the `unstable\_dataStrategy` API](https://reactrouter.com/en/main/start/changelog#v6262)   
