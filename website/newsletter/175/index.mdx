---
slug: /175
title: "This Week In React #175: React Server Components, useSyncExternalStore, Vinxi, Server Actions, margins, FormData, WakuLand, R3F-uikit, React-Forget, RN releases, Bridgeless, Expo Fingerprint, Flash Calendar, Zeego, RN Reusables..."
authors: [slorber]
date: 02-28-2024
unlisted: true
---
...
This week is a funny one: almost no releases, but a lot of great React articles 😄!
...
- 📜 [Compiler Theory and Reactivity](https://www.recompiled.dev/blog/ssa/): Sathya works on React Forget and explains a compiler theory pass they are using: Static Single Assignment form. I have to admit I’m a bit lost here 😅. His previous post on [Alias analysis](https://www.recompiled.dev/blog/alias-analysis/) is easier to understand.
