...
There's notably an important terminology change for Server Actions, and an exciting preview of upcoming React DevTools v6.

On the React Native side we also have a broad set of very interesting news
