---
slug: /279
title: "This Week In React #279: Compiler, TSRX, StyleX, XState, Hook Form, TanStack, shadcn CLI, Chakra, Inertia, Tooltip, Mantine | SPM, SimCam, Quick Crypto, Enriched Markdown, Agent Device, Navigation SDK, JSI, Paste Input, Nitro MLX, Jail Monkey | pnpm, Aube, Fresh, Node.js"
...
- 📦 [Quick Crypto 1.1 \- simdutf for faster string encoding/decoding, Buffer semantics now match](https://github.com/margelo/react-native-quick-crypto/releases/tag/v1.1.0) [Node.js](http://Node.js) [semantics, OpenSSL-Universal CocoaPods dep](https://github.com/margelo/react-native-quick-crypto/releases/tag/v1.1.0)
