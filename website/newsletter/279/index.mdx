---
slug: /279
title: "This Week In React #279: Hook Form, ToolTop, Shadcn, Xstate, StyleX, Chakra, Inertia, Mantine, Tanstack | SimCam, Quick Crypto, Enriched Markdown, agent-device, Navigation SDK, Paste Input, Nitro Mix, Jail Monkey | pnpm, Aube, Fresh"
authors: [kacperkapusciak, konradarmatys]
date: 04-29-2026
unlisted: true
---

Hi everyone, Konrad and Kacper from [Software Mansion](https://swmansion.com/) here\!

This week brings a couple of solid articles and releases in the React ecosystem. On the React side, we have a WIP Rust port confirmed in testing at Meta, an 18-month retrospective on the React Compiler, a deep dive into how React streams UI, and a step-by-step guide for migrating from Radix UI to Base UI. There's also a fresh batch of releases, including React Hook Form, Chakra UI, Mantine 9.1, and TanStack Query.

On the React Native front, an RFC has landed proposing SPM support to replace CocoaPods, and React Navigation v8 will gain a `retain` API to keep screens mounted after going back. Don't miss the blog on making pure JSI code faster.
...
- 📦 [React Native Quick Crypto 1.1 \- simdutf for faster string encoding/decoding, Buffer semantics now match](https://github.com/margelo/react-native-quick-crypto/releases/tag/v1.1.0) [Node.js](http://Node.js) [semantics, OpenSSL-Universal CocoaPods dep](https://github.com/margelo/react-native-quick-crypto/releases/tag/v1.1.0)
- 📦 [RN Enriched Markdown 0.5 \- Support macOS, web, `EnrichedMarkdownTextInput`, spoiler elements, auto-link detection, VoiceOver/TalkBack improvements](https://github.com/software-mansion-labs/react-native-enriched-markdown/releases/tag/v0.5.0)
...
- 📦 [react-native-nitro-mix 0.5 \- Expo 55 support, added Embeddings module, ChatSession API, and streaming downloads](https://github.com/corasan/react-native-nitro-mlx/releases/tag/v0.5.0)
...
![alt](/emails/issues/279/meme.png)
